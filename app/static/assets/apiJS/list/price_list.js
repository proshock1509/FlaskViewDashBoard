...
var totalPriceChart = function(t_data){
    var PieChartData = {
        labels : t_data["price_level"],
        datasets : [{
...
var total_price_data
$.ajax('/api/price', {
    type: 'post',
    async : false,
    contentType: "application/json",
    success : function(res) {
        total_price_data = res["data"]
...
totalPriceChart(total_price_data)


var count = 8
var price_l = total_price_data["price_level"]
price_l.forEach(d=>{
    ...
    $.ajax("/api/list/price_items", {
        type : "post",
        async : false,
        dataType: 'json',
        contentType : "application/json",
        data : JSON.stringify({"price_level": d, "count": count}),
        success : function(res){
    ...
    agency_items_data.forEach(element => {
        ...
        <a href="#">\
            <div class="card-header bg-transparent" >\
                ...
                <p class="text-danger ls-1 mb-0" style="font-size:0.8rem">' +element["count"] + '+ BĐS '+ element["price_level"] +'</p>\
