...
var totalTypeChart = function(t_data){
    var PieChartData = {
        labels : t_data["type_re_name"],
        datasets : [{
...
var count = 8
var type_l = total_type_data["type_re_name"]
type_l.forEach(d=>{
    ...
    $.ajax("/api/list/type_items", {
        type : "post",
        async : false,
        dataType: 'json',
        contentType : "application/json",
        data : JSON.stringify({"type_re_name": d, "count": count}),
        success : function(res){
    ...
    agency_items_data.forEach(element => {
        ...
        <a href="#">\
            <div class="card-header bg-transparent" >\
                ...
                <p class="text-danger ls-1 mb-0" style="font-size:0.8rem">' +element["count"] + '+ BĐS '+ element["type_re_name"] +'</p>\
...
$(document).ready(function(){
    totalTypeChart(total_type_data)
